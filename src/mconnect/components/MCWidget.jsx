...
export default function MCWidget() {
  ...
  if (!isLoggedIn) {
    return (
      <div className="flex min-h-screen w-full items-center justify-center px-5 md:px-10 bg-[#F0EFEA]">
    ...
    <div className="flex flex-col gap-12 items-center justify-center w-full">
      ...
      <div className="flex flex-col w-full">
        <button
          ...
          className="py-3 text-sm flex gap-4 items-center justify-start w-full"
        >
