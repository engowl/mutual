export default function ProjectOwnerOfferStatusBadgePill({ status }) {
  switch (status) {
    case "CREATED":
      return (
    ...
    case "VERIFIED":
      return (
        <span className="px-2 py-1 rounded-lg bg-blue-500/10 border border-blue-500/20 text-blue-500 text-xs font-medium">
          Verified
        </span>
      );
    case "ACCEPTED":
